...
fundsr plots tracking differences (CAGR and log-return) and survival
curves.
...
fundsr is an analysis tool for DIY investors. It does not include or
provide market data; users are responsible for sourcing any ETF NAV and
index-level data they use, subject to the terms of their data sources.
The package also supports plotting survival curves.
...
- See also `scripts/examples` in the package directory (locate via
