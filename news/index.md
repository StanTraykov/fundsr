...
- make `var_name` param optional for all provider wrappers (fund and
  index)
- add `override_ext` param to
...
- [`reset_state()`](https://stantraykov.github.io/fundsr/reference/reset_state.md)
  clears cached storage, loader registry, queued exports, and other
