...
#> Returning 3721 rows x 2 columns from 'data/funds/SPYY.xlsx' (sheet='1', date_field='^Date').
#> *** Loading: iusq
#> Attempting readxl on 'data/funds/IUSQ.xls'...
#> readxl failed. Attempting parse as Excel 2003 XML...
#> Returning 3615 rows x 3 columns from 'data/funds/IUSQ.xls' (sheet='Historical', date_field='^As Of').
```
...
#>    date        iusq  ACWI
#>    <date>     <dbl> <dbl>
#>  1 2025-12-18  107.  431.
#>  2 2025-12-17  106.  428.
#>  3 2025-12-16  107.  432.
#>  4 2025-12-15  108.  434.
#>  5 2025-12-12  108.  434.
#>  6 2025-12-11  109.  437.
#>  7 2025-12-10  108.  436.
#>  8 2025-12-09  108.  433.
#>  9 2025-12-08  108.  434.
#> 10 2025-12-05  108.  435.
#> # ℹ 3,605 more rows
series
#> # A tibble: 3,336 × 4
#>    date        spyy  iusq  ACWI
...
Files in the `output` directory should look like:
![CAGR diffs](images/ACWI.png){width=88%}
![log-ret diffs](images/ACWI_L.png){width=88%}
![XLM plot](images/xlm_ACWI.png){width=88%}
