---
title: "life: Survival chances for financial planning"
author: "Stanislav Traykov"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{life: Survival chances for financial planning}
...
Download from HMD and EUROSTAT, see [wiki](https://github.com/StanTraykov/fundsr/wiki/Life-stats) for links and more info.
...
HMD requires login but licenses CC-BY, so I host (potentially outdated) data for this vignette. You may
download current data directly from HMD for actual use (it's free).

* HMD. Human Mortality Database. Max Planck Institute for Demographic Research (Germany), University of California, Berkeley (USA), and French Institute for Demographic Studies (France). Available at www.mortality.org. See data repo [README.md](https://github.com/StanTraykov/fundsr-data/blob/main/README.md) for more details.
...
The next steps assume the following files are in the `data_dir` (`data/life`) directory:
```
[data/life] $ ls
